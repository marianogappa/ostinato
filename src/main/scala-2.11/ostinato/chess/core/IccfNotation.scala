...
case class IccfNotationActionParser(r: IccfNotationRules) extends ActionParser {
  ...
  protected def castling(a: CastlingAction)(implicit rules: ChessRules = ChessRules.default) = action(a)
